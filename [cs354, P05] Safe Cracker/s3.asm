...
00001140 <__libc_start_main@plt>:
...
00001170 <_start>:
    ...
    118a:	8d 83 08 d5 ff ff    	lea    -0x2af8(%ebx),%eax
    1190:	50                   	push   %eax
    1191:	8d 83 98 d4 ff ff    	lea    -0x2b68(%ebx),%eax
    1197:	50                   	push   %eax
    1198:	51                   	push   %ecx
    1199:	56                   	push   %esi
    119a:	ff b3 40 00 00 00    	pushl  0x40(%ebx)
    11a0:	e8 9b ff ff ff       	call   1140 <__libc_start_main@plt>
    11a5:	f4                   	hlt    
...
0000133d <main>:
    ...
    1375:	74 27                	je     139e <main+0x61>
    1377:	8b 83 3c 00 00 00    	mov    0x3c(%ebx),%eax
    137d:	8b 38                	mov    (%eax),%edi
    137f:	be 00 00 00 00       	mov    $0x0,%esi
    1384:	8b 83 3c 00 00 00    	mov    0x3c(%ebx),%eax
    138a:	89 85 d4 fd ff ff    	mov    %eax,-0x22c(%ebp)
    1390:	8d 83 da e0 ff ff    	lea    -0x1f26(%ebx),%eax
    1396:	89 85 d0 fd ff ff    	mov    %eax,-0x230(%ebp)
    139c:	eb 3c                	jmp    13da <main+0x9d>
    139e:	83 ec 08             	sub    $0x8,%esp
    13a1:	8d 93 d8 e0 ff ff    	lea    -0x1f28(%ebx),%edx
    13a7:	52                   	push   %edx
    13a8:	ff 70 04             	pushl  0x4(%eax)
    13ab:	e8 a0 fd ff ff       	call   1150 <fopen@plt>
    13b0:	89 c7                	mov    %eax,%edi
    13b2:	83 c4 10             	add    $0x10,%esp
    13b5:	eb c8                	jmp    137f <main+0x42>

    13b7:	83 ec 04             	sub    $0x4,%esp
    13ba:	8d 46 01             	lea    0x1(%esi),%eax
    13bd:	50                   	push   %eax
    13be:	ff b5 d0 fd ff ff    	pushl  -0x230(%ebp)
    13c4:	6a 01                	push   $0x1
    13c6:	e8 95 fd ff ff       	call   1160 <__printf_chk@plt>
    13cb:	83 c4 10             	add    $0x10,%esp
    13ce:	eb 14                	jmp    13e4 <main+0xa7>


13d0:	e8 d8 fe ff ff       	call   FAIL

    13d5:	83 fe 04             	cmp    $0x4,%esi
    13d8:	7f 42                	jg     SUCCESS
    13da:	8b 85 d4 fd ff ff    	mov    -0x22c(%ebp),%eax
    13e0:	39 38                	cmp    %edi,(%eax)
    13e2:	74 d3                	je     13b7 <main+0x7a>

        13e4:	83 ec 04             	sub    $0x4,%esp
        13e7:	57                   	push   %edi
        13e8:	68 00 02 00 00       	push   $0x200
        13ed:	8d 85 e4 fd ff ff    	lea    -0x21c(%ebp),%eax
        13f3:	50                   	push   %eax
        13f4:	e8 f7 fc ff ff       	call   10f0 <fgets@plt>
        13f9:	83 c4 10             	add    $0x10,%esp
        13fc:	85 c0                	test   %eax,%eax
        13fe:	74 d5                	je     13d5 <main+0x98>

    1400:	83 ec 08             	sub    $0x8,%esp
    1403:	ff b4 b3 50 00 00 00 	pushl  0x50(%ebx,%esi,4)
    140a:	50                   	push   %eax
    140b:	e8 d0 fc ff ff       	call   10e0 <strcmp@plt>
    1410:	83 c4 10             	add    $0x10,%esp
    1413:	85 c0                	test   %eax,%eax
    1415:	75 b9                	jne    13d0 <main+0x93>

    1417:	83 c6 01             	add    $0x1,%esi
    141a:	eb b9                	jmp    13d5 <main+0x98>
    
    
    # SUCCESS
    141c:	e8 d7 fe ff ff       	call   12f8 <success>
    # cleanup
    1421:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1424:	65 33 05 14 00 00 00 	xor    %gs:0x14,%eax
    142b:	75 11                	jne    143e <main+0x101>
    142d:	b8 00 00 00 00       	mov    $0x0,%eax
    1432:	8d 65 f0             	lea    -0x10(%ebp),%esp
    1435:	59                   	pop    %ecx
    1436:	5b                   	pop    %ebx
    1437:	5e                   	pop    %esi
    1438:	5f                   	pop    %edi
    ...
    143d:	c3                   	ret    
    143e:	e8 8d 00 00 00       	call   14d0 <__stack_chk_fail_local>
...
00001450 <__libc_csu_init>:
    1450:	f3 0f 1e fb          	endbr32 
    1454:	55                   	push   %ebp
    1455:	e8 6b 00 00 00       	call   14c5 <__x86.get_pc_thunk.bp>
    145a:	81 c5 5e 2b 00 00    	add    $0x2b5e,%ebp
    1460:	57                   	push   %edi
    1461:	56                   	push   %esi
    1462:	53                   	push   %ebx
    1463:	83 ec 0c             	sub    $0xc,%esp
    1466:	89 eb                	mov    %ebp,%ebx
    1468:	8b 7c 24 28          	mov    0x28(%esp),%edi
    146c:	e8 8f fb ff ff       	call   1000 <_init>
    1471:	8d 9d 04 ff ff ff    	lea    -0xfc(%ebp),%ebx
    1477:	8d 85 00 ff ff ff    	lea    -0x100(%ebp),%eax
    147d:	29 c3                	sub    %eax,%ebx
    147f:	c1 fb 02             	sar    $0x2,%ebx
    1482:	74 29                	je     14ad <__libc_csu_init+0x5d>
    ...
    1493:	57                   	push   %edi
    1494:	ff 74 24 2c          	pushl  0x2c(%esp)
    1498:	ff 74 24 2c          	pushl  0x2c(%esp)
    149c:	ff 94 b5 00 ff ff ff 	call   *-0x100(%ebp,%esi,4)
    14a3:	83 c6 01             	add    $0x1,%esi
    14a6:	83 c4 10             	add    $0x10,%esp
    14a9:	39 f3                	cmp    %esi,%ebx
    14ab:	75 e3                	jne    1490 <__libc_csu_init+0x40>
    14ad:	83 c4 0c             	add    $0xc,%esp
    14b0:	5b                   	pop    %ebx
    14b1:	5e                   	pop    %esi
    14b2:	5f                   	pop    %edi
    14b3:	5d                   	pop    %ebp
    14b4:	c3                   	ret    
    14b5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    14bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

000014c0 <__libc_csu_fini>:
    14c0:	f3 0f 1e fb          	endbr32 
    14c4:	c3                   	ret    

000014c5 <__x86.get_pc_thunk.bp>:
    14c5:	8b 2c 24             	mov    (%esp),%ebp
    14c8:	c3                   	ret    
...
000014d0 <__stack_chk_fail_local>:
    14d0:	f3 0f 1e fb          	endbr32 
    14d4:	53                   	push   %ebx
    14d5:	e8 d6 fc ff ff       	call   11b0 <__x86.get_pc_thunk.bx>
    14da:	81 c3 de 2a 00 00    	add    $0x2ade,%ebx
    14e0:	83 ec 08             	sub    $0x8,%esp
    14e3:	e8 28 fc ff ff       	call   1110 <__stack_chk_fail@plt>
...
000014e8 <_fini>:
    ...
    14f0:	e8 bb fc ff ff       	call   11b0 <__x86.get_pc_thunk.bx>
    14f5:	81 c3 c3 2a 00 00    	add    $0x2ac3,%ebx
    14fb:	83 c4 08             	add    $0x8,%esp
    14fe:	5b                   	pop    %ebx
    14ff:	c3                   	ret    
