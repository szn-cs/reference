 ...
 * 
 * TODO: Complete the implementation of the three methods below: 1. insertGrade() 2.
 * getSpecificGradesRate() 3. testInsertInvalidGrade()
 * 
 * Note that when creating new exception objects, including descriptive messages within these
 * objects is optional.
 *
 */
public class Grades_original {
  ...
  public static int insertGrade(double[] grades, int size, double newGrade) {
    ...
    return 0; // This statement was added to make this code compiles without errors
  }
  ...
  public static double getSpecificGradesPortion(double[] grades, int size, double threshold) {
    ...
    return 0.0; // This statement was added to make this code compiles without errors
  }
