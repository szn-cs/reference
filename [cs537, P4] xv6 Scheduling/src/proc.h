...
struct proc {
  ...
  int sleepDuration;
  int timeSleptAt;  // time sleeping started
  int compticks;    // compensation ticks granted for the process
  ...
  struct statistics {
    ...
    /* total num times this process has been scheduled.
        ...
        Incremented whenever:
            ...
            - also in the case where it finishes its time-slice and gets
                scheduled immediately again.
