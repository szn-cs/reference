...
/**
 * P2 class: tests the test the C-- scanner testing all tokens, and related classes. 
 * 
 * e.g., input that causes errors, character numbers, values associated with tokens
 * <p>
